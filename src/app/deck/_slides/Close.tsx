  ...
  return (
    <Slide tone="ink" n={n} section="" label="Every seat, slot and session, accounted for">
      ...
      <div className={cn(s.text, "text-center")} style={{ left: 150, top: 430, width: 1300 }}>
        ...
        {/*
          The ask: one next step, with the address written out. Drawn rather than
          linked, like every other control on a slide — the slide scales to a fifth
          of its size on a phone, where no link could be tapped.
        */}
