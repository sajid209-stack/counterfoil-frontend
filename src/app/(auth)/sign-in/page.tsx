...
export default function SignInPage() {
  return (
    <div className="card-surface p-major">
      ...
      <button
        type="button"
        className="mt-major flex h-11 w-full items-center justify-center rounded-sm bg-brand-600 text-sm font-medium text-white transition-colors duration-quick hover:bg-brand-600 active:bg-brand-700"
      >
        Sign in
      </button>
