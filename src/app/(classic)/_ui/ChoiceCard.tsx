/* Restored from acb8291 - the last commit before the 6 September redesign.
 * Kept as the classic till's OWN copy so the shared primitive can keep
 * moving without dragging this variant with it. The differences that matter
 * here: ink on ember rather than white, and the 6px corner rather than the
 * Go pill. */
"use client";
