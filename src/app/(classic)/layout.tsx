...
import { TillSwitcher } from "../(go)/_components/TillSwitcher";
import { LocaleToggle } from "@/components/LocaleProvider";
import { Logo, Modal } from "./_ui";
...
const TABS = [
  // Sell stays inside the classic variant. The other three are the same
  // screens in either design, so they lead back to the Go chrome rather than
  // being copied a second time — this variant is a TILL design, not a fork of
  // front-of-house.
  { href: "/classic", key: "sell", icon: Store },
